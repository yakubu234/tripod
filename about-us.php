					...
					<div class="breaking-news-content">
						...
						<div class="breaking-news-slides owl-carousel owl-theme">
							<div class="single-breaking-news">
								<p>
									<a href="about-us.html#">Entertainment activists started again a few months later</a>
								</p>
							</div>
							<div class="single-breaking-news">
								<p>
			...
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<div class="single-footer-widget">
						...
						<ul class="social">
							<li>
								<a href="about-us.html#" class="facebook" target="_blank">
									<i class='bx bxl-facebook'></i>
								</a>
							</li>
							<li>
								<a href="about-us.html#" class="twitter" target="_blank">
									<i class='bx bxl-instagram'></i>
								</a>
							</li>
							<li>
								<a href="about-us.html#" class="pinterest" target="_blank">
									<i class='bx bxl-linkedin'></i>
								</a>
							</li>
							<li>
								<a href="about-us.html#" class="linkedin" target="_blank">
									<i class='bx bxl-twitter'></i>
								</a>
							</li>
							<li>
					...
					<div class="single-footer-widget">
						...
						<div class="post-content">
							<div class="row align-items-center">
								...
								<div class="col-md-8">
									<h4>
										<a href="about-us.html#">The match of the volleyball full of excitement</a>
									</h4>
				...
				<div class="col-lg-3 col-md-6">
					<div class="single-footer-widget">
						...
						<ul class="useful-links-list">
							...
							<li>
								<a href="about-us.html#">Affilate ads</a>
							</li>
							<li>
							...
							<li>
								<a href="about-us.html#">Politics</a>
							</li>
						</ul>
					</div>
				</div>
