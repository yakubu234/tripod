		...
		<div class="row">
			<div class="col-lg-6">
				<div class="single-main-default-news-inner">
					<a href="<?php echo 'news.php?read='.$item["heading"].'&dataID='.$item["id"]; ?>">
						<img src="uploads/<?php echo $item['image']; ?>" alt="image" id="image-height">
					</a>
					<div class="news-content">
						<div class="tag"><?php echo $item['category'] ?> </div>
						<h3>
							<a href="<?php echo 'news.php?read='.$item["heading"].'&dataID='.$item["id"]; ?>"><?php echo  substr($item['heading'], 0, 76); ?> ...</a>
						</h3>
						...
						echo '
							<div class="col-sm-6" >
								<div class="single-main-default-news">
									<a href="news.php?read='.$elem["heading"].'&dataID='.$elem["id"].'">
										<img src="uploads/'.$elem['image'].'" id="image-height-two" alt="image">
									</a>
									<div class="news-content">
										<div class="tag">'.$elem["category"].'</div>
										<h3>
											<a href="news.php?read='.$elem["heading"].'&dataID='.$elem["id"].'">'.substr($elem["heading"], 0, 36).' ....</a>
										</h3>
								...
								<div class="col-lg-6">
									<div class="single-most-popular-news">
										...
										<div class="popular-news-content">
											...
											<h3>
												<a href="news.php?read='.$elem["heading"].'&dataID='.$elem["id"].'">'.substr($elem["heading"], 0, 50).' ....</a>
											</h3>
											<p><a href="news.php?read='.$elem["heading"].'&dataID='.$elem["id"].'">Patricia</a> / '.date("d F Y ",strtotime($elem['time'])).'</p>
										</div>
									</div>
								</div>
							';
								...
								<div class="row align-items-center">
									...
									<div class="col-lg-8 col-sm-8">
										<div class="post-content">
											<span>'.$elem["location"].'</span>
											<h3>
												<a href="news.php?read='.$elem["heading"].'&dataID='.$elem["id"].'">'.substr($elem["heading"], 0, 39).' ....</a>
											</h3>
					...
					foreach ($indexData as $index => $elemment) {
						...
						<div class="single-politics-news">
							<div class="politics-news-image">
								<a href="news.php?read='.$elemment["heading"].'&dataID='.$elemment["id"].'">
							...
							<div class="politics-news-content">
								...
								<h3>
									<a href="news.php?read='.$elemment["heading"].'&dataID='.$elemment["id"].'">'.substr($elemment["heading"], 0, 36).' ....</a>
								</h3>
								<p><a href="news.php?read='.$elemment["heading"].'&dataID='.$elemment["id"].'">Jonson Steven</a> /'.date("d F Y ",strtotime($elemment['time'])).'</p>
							</div>
						</div>
							';
						if ($index >= 4) {break;}
						...
						echo '
							<div class="col-lg-6 col-md-6">
								<div class="politics-news-post-box">
									<a href="news.php?read='.$elemm["heading"].'&dataID='.$elemm["id"].'">
										<img src="uploads/'.$elemm['image'].'" id="image-height-two" alt="image">
									</a>
									<div class="politics-news-content">
										...
										<h3>
											<a href="news.php?read='.$elemm["heading"].'&dataID='.$elemm["id"].'">'.substr($elemm["heading"], 0, 36).' ....</a>
										</h3>
