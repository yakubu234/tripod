...
<section class="about-area ptb-50 col-sm-7" style="margin: 0px auto;">
	<div class="container">
		...
		<form method="POST" action="fetcher.php?datas=newPost<?php echo microtime(); ?>" >
			<div class="mb-3">
			...
			<div class="mb-3">
				...
				<input type="file" class="form-control" name="name" id="exampleFormControlInput11" placeholder="full name"  required="">
			</div>
			<div class="mb-3">
			...
			<div class="col-sm" style="padding-left:10%;" >
				<button type="submit" class="btn btn-success text-white" style="float: right;" >Pist News</button>
			</div>
			<br><br>
		</form>
