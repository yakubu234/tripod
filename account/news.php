...
if (isset($_SESSION['stuData'])) {
	...
	$linkD =  '<b style="color:black;" >'.$replacement.' </b><br><a style="color:red;" href ="https://tripodmedia.org/'.$replacement.'&dataID='.$insid.'" target="_blank" id="p1">https://tripodmedia.org/'.$replacement.'&dataID='.$insid.'<a/>';
}else{
