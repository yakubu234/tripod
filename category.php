<?php include "include/fetcher.php"; $page="Home";$dat = $_GET['data'];$og_graph = ""; include "include/og_graph.php";include "include/header.php"; include "api.php";
					...
					<div class="row align-items-center">
						<div class="col-lg-4">
							<div class="news-image">
								<a href="news.php?read='.$value["heading"].'&dataID='.$value["id"].'">
						...
						<div class="col-lg-8">
							<div class="news-content">
								...
								<h3>
									<a href="news.php?read='.$value["heading"].'&dataID='.$value["id"].'">'.substr($value["heading"], 0, 66).' ....</a>
								</h3>
								<p>'.mb_strimwidth(strip_tags($value["news"]), 0, 135).' ....</p>
								<p><a href="news.php?read='.$value["heading"].'&dataID='.$value["id"].'">'.$value["actor"].'</a> / '.date("d F Y ",strtotime($value['time'])).'</p>
							</div>
						</div>
					</div>
				</div>
